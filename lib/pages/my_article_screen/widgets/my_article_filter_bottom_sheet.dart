...
class MyArticleFilterBottomSheet extends StatefulWidget {
  const MyArticleFilterBottomSheet({
    Key? key,
  }) : super(key: key);

  @override
  State<MyArticleFilterBottomSheet> createState() =>
      _MyArticleFilterBottomSheetState();
}

class _MyArticleFilterBottomSheetState
    extends State<MyArticleFilterBottomSheet> {
