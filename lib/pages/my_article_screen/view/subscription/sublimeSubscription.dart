...
class SublimeSubscription extends StatefulWidget {
  const SublimeSubscription({
    Key? key,
  }) : super(key: key);

  @override
  State<SublimeSubscription> createState() => _SublimeSubscriptionState();
}

class _SublimeSubscriptionState extends State<SublimeSubscription> {
          ...
          children: [
            Container(
              ...
              child: PageView(
                  ...
                  children: [
                    propCard(context, "monthly", "13.99"),
                    propCard(context, "yearly", "12.99"),
                  ]),
            ),
            const SizedBox(
              height: 10,
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Text(
                                "No props deduction when notifying vendors",
                                style: ralewayStyle(
                                    16, FontWeight.w500, Colors.white),
                              ),
                            ),
